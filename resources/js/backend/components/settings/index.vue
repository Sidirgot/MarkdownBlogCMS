    ...
    <div class="mx-4">
        ...
        <div class="bg-navbar rounded shadow-full px-4 pb-6 text-white" v-show="! loading">
            ...
            <h1 class="text-lg text-white tracking-wider py-4 flex justify-between items-center">
                ...
                <button class="btn btn-blue flex items-center" @click="$modal.show('setting-create')">
                    Create New Setting 
            ...
            <table class="table-fixed w-full text-center text-sm">
                ...
                <transition-group name="fade" tag="tbody">
                    <tr class="even:bg-main-dark odd:bg-navbar leading-8" v-for="( setting, index ) in settings" :key="setting.id">
                        <td class="py-2">{{ setting.type }}</td>
                        <td class="flex flex-wrap md:inline-flex py-2">
